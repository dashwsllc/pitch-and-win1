...
const version = '20260920220000'
const name = 'registration_requested_roles'
...
writeFileSync('.verification.local/registration-role-apply.sql', query)
const result = spawnSync(
  'npx',
  ['supabase', 'db', 'query', '--linked', '--project-ref', 'mbzwchnxtskysqplqiyy', '--file', '.verification.local/registration-role-apply.sql', '--output', 'json'],
