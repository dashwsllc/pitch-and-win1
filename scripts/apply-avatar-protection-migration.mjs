...
const version = '20260914193000'
const name = 'avatar_target_protection'
...
writeFileSync('.verification.local/avatar-protection-apply.sql', query)
const result = spawnSync(
  ...
  [
    ...
    '--file',
    '.verification.local/avatar-protection-apply.sql',
    '--output',
    'json',
  ],
  {
