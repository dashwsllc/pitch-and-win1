...
// Publish only the reviewed synchronization migration. This repository has
// earlier migrations that were applied independently, so a blanket push is
// intentionally avoided.
const version = '20260920203000'
const name = 'complete_dashboard_realtime_signals'
...
writeFileSync('.verification.local/dashboard-realtime-apply.sql', query)
const result = spawnSync(
  'npx',
  ['supabase', 'db', 'query', '--linked', '--project-ref', 'mbzwchnxtskysqplqiyy', '--file', '.verification.local/dashboard-realtime-apply.sql', '--output', 'json'],
