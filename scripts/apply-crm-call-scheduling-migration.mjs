...
// Applies only the reviewed atomic scheduling migration.
const version = '20260910030000'
const name = 'crm_claim_on_call_schedule'
...
writeFileSync('.verification.local/crm-call-scheduling-apply.sql', query)
const result = spawnSync(
  'npx',
  ['supabase','db','query','--linked','--project-ref','mbzwchnxtskysqplqiyy','--file','.verification.local/crm-call-scheduling-apply.sql','--output','json'],
