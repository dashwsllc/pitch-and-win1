...
const version = '20260920223000'
const name = 'registration_role_trigger_alignment'
...
writeFileSync('.verification.local/registration-role-trigger-apply.sql', query)
const result = spawnSync(
  'npx',
  ['supabase', 'db', 'query', '--linked', '--project-ref', 'mbzwchnxtskysqplqiyy', '--file', '.verification.local/registration-role-trigger-apply.sql', '--output', 'json'],
