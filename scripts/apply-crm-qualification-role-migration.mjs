...
const name = 'closer_inherits_sdr_qualification'
...
writeFileSync('.verification.local/apply-crm-qualification-role.sql', query)
const result = spawnSync('npx', [
  'supabase','db','query','--linked','--project-ref','mbzwchnxtskysqplqiyy',
  '--file','.verification.local/apply-crm-qualification-role.sql','--output','json',
