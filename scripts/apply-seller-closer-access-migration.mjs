...
// Applies only the reviewed seller-to-Closer capability migration.
const version = '20260910120000'
const name = 'seller_closer_access'
...
writeFileSync('.verification.local/seller-closer-access-apply.sql', query)
const result = spawnSync(
  'npx',
  ['supabase','db','query','--linked','--project-ref','mbzwchnxtskysqplqiyy','--file','.verification.local/seller-closer-access-apply.sql','--output','json'],
