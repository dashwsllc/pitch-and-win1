...
// Publish only this reviewed ranking migration. Earlier migrations in this
// project were applied independently, so a blanket database push is unsafe.
const version = '20260922130000'
const name = 'role_scoped_rankings'
...
writeFileSync('.verification.local/role-scoped-rankings-apply.sql', query)
const result = spawnSync(
  'npx',
  ['supabase', 'db', 'query', '--linked', '--project-ref', 'mbzwchnxtskysqplqiyy', '--file', '.verification.local/role-scoped-rankings-apply.sql', '--output', 'json'],
