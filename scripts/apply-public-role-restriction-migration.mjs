...
const version = '20260920230000'
const name = 'restrict_public_administrative_roles'
...
writeFileSync('.verification.local/public-role-restriction-apply.sql', query)
const result = spawnSync(
  'npx',
  ['supabase', 'db', 'query', '--linked', '--project-ref', 'mbzwchnxtskysqplqiyy', '--file', '.verification.local/public-role-restriction-apply.sql', '--output', 'json'],
