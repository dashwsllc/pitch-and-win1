...
// Publish only the reviewed sales-management migration. Older installations
// contain manually applied CRM migrations, so a blanket db push is unsuitable.
const version = '20260914120000'
const name = 'sales_management'
...
writeFileSync('.verification.local/sales-management-apply.sql', query)
const result = spawnSync('npx', ['supabase', 'db', 'query', '--linked', '--project-ref', 'mbzwchnxtskysqplqiyy', '--file', '.verification.local/sales-management-apply.sql', '--output', 'json'], {
