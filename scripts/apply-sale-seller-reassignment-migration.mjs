...
const name = 'sale_seller_reassignment'
...
writeFileSync('.verification.local/sale-seller-reassignment-apply.sql', query)
const result = spawnSync(
  'npx',
  ['supabase', 'db', 'query', '--linked', '--project-ref', 'mbzwchnxtskysqplqiyy', '--file', '.verification.local/sale-seller-reassignment-apply.sql', '--output', 'json'],
